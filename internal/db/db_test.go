...
func TestMigrateRecordsVersionsAndDoesNotReplayAppliedMigrations(t *testing.T) {
	...
	if want := []string{"001_initial", "002_permission_denies", "003_upload_session_length", "004_upload_session_lifecycle", "005_audit_event_status"}; fmt.Sprint(versions) != fmt.Sprint(want) {
