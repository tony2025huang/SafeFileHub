...
func TestMigrateRecordsVersionsAndDoesNotReplayAppliedMigrations(t *testing.T) {
	...
	if want := []string{"001_initial", "002_permission_denies", "003_upload_session_length", "004_upload_session_lifecycle", "005_audit_event_status", "006_directories", "007_published_lifecycle", "008_published_parent_invariant"}; fmt.Sprint(versions) != fmt.Sprint(want) {
