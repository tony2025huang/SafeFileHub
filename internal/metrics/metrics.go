...
type Snapshot struct{ ActiveUploads, ActiveDownloads, ActiveLeases, TooManyRequests, Unavailable, Cancellations, Cleanup int64 }
type Metrics struct{ uploads, downloads, leases, tooMany, unavailable, cancellations, cleanup atomic.Int64 }
